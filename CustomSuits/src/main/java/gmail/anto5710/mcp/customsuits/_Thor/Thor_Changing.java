...
public class Thor_Changing extends BukkitRunnable{
	...
	public static Map<Player, Location>Changing_players = new HashMap<>();
	public static Map<Player, Double>PhiValues = new HashMap<>();
	...
	public void run() {
		...
		while (iterator.hasNext()) {
			...
			if (!removed.contains(player) && (player.isDead() || !player.isOnline())) {
				removed.add(player);
				iterator.remove();
			}
